# This was written for the previous simulation: github.com/ideo/avocado-allegory
# Leaving it in the repo in case we also want to explore this method for
# selecting a winner from the final list of nominees.
